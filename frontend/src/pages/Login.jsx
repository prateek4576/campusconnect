...
export default function Login() {
  const { login, googleLogin, formatApiErrorDetail } = useAuth();
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch">
          ...
          <div className="bg-[#0B294B] text-white border-2 border-black brutal-shadow-lg p-8 w-full lg:w-3/5">
            ...
            <p className="text-sm leading-relaxed mb-8">
              Your account keeps your lost &amp; found activity, messages, and
          ...
          <div className="bg-white border-2 border-black brutal-shadow-lg p-8 w-full lg:w-2/5">
            ...
            <p className="text-sm mb-6">Log in to report or browse items.</p>
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <button
                ...
                disabled={busy}
                className="w-full bg-white text-black border-2 border-black px-4 py-3 brutal-shadow-sm brutal-press font-bold uppercase flex items-center justify-center gap-3 disabled:opacity-60"
              >
